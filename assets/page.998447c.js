const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/mermaid.core.998447c.js","assets/preload-helper.998447c.js"])))=>i.map(i=>d[i]);
import{_ as g}from"./preload-helper.998447c.js";const c=()=>document.querySelectorAll("pre.mermaid").length>0;let d=null;async function h(){return d||(console.log("[astro-mermaid] Loading mermaid.js..."),d=g(()=>import("./mermaid.core.998447c.js").then(r=>r.bE),__vite__mapDeps([0,1])).then(async({default:r})=>{const t=[];if(t&&t.length>0){console.log("[astro-mermaid] Registering",t.length,"icon packs");const a=t.map(e=>({name:e.name,loader:new Function("return "+e.loader)()}));await r.registerIconPacks(a)}return r}).catch(r=>{throw console.error("[astro-mermaid] Failed to load mermaid:",r),d=null,r}),d)}const m={startOnLoad:!1,theme:"default"},b={light:"default",dark:"dark"};async function s(){console.log("[astro-mermaid] Initializing mermaid diagrams...");const r=document.querySelectorAll("pre.mermaid");if(console.log("[astro-mermaid] Found",r.length,"mermaid diagrams"),r.length===0)return;const t=await h();let a=m.theme;{const e=document.documentElement.getAttribute("data-theme"),n=document.body.getAttribute("data-theme");a=b[e||n]||m.theme,console.log("[astro-mermaid] Using theme:",a,"from",e?"html":"body")}t.initialize({...m,theme:a,gitGraph:{mainBranchName:"main",showCommitLabel:!0,showBranches:!0,rotateCommitLabel:!0}});for(const e of r){if(e.hasAttribute("data-processed"))continue;e.hasAttribute("data-diagram")||e.setAttribute("data-diagram",e.textContent||"");const n=e.getAttribute("data-diagram")||"",o="mermaid-"+Math.random().toString(36).slice(2,11);console.log("[astro-mermaid] Rendering diagram:",o);try{const i=document.getElementById(o);i&&i.remove();const{svg:u}=await t.render(o,n);e.innerHTML=u,e.setAttribute("data-processed","true"),console.log("[astro-mermaid] Successfully rendered diagram:",o)}catch(i){console.error("[astro-mermaid] Mermaid rendering error for diagram:",o,i),e.innerHTML=`<div style="color: red; padding: 1rem; border: 1px solid red; border-radius: 0.5rem;">
